...
int main(){
    //Remove loop from the cicular linked list
    Node* tail = NULL;
    ...
    bool beforecheck = iscircular(tail);
    cout<<"from above removeloop before checking if the LL circular or not "<<beforecheck<<endl;
    ...
    bool check = iscircular(tail);
    cout<<"from above removeloop checking if the LL circular or not "<<check<<endl;
